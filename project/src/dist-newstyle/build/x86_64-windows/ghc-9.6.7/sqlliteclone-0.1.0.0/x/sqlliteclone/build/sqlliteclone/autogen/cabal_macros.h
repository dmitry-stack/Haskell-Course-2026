...
/* package sqlliteclone-0.1.0.0 */
#ifndef VERSION_sqlliteclone
#define VERSION_sqlliteclone "0.1.0.0"
#endif /* VERSION_sqlliteclone */
#ifndef MIN_VERSION_sqlliteclone
#define MIN_VERSION_sqlliteclone(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_sqlliteclone */
...
#define CURRENT_COMPONENT_ID "sqlliteclone-0.1.0.0-inplace-sqlliteclone"
